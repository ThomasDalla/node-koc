...
var recruit = function(page, data) {
    // we need to be logged in
    var _koc = this;
    if( !this.hasSession() ) {
        return Q(_koc.prepareResponse({
    ...
    if(data===undefined||data===null||data=={}) {
        ...
        p = _koc.requestPage("GET", page, {}, function(response, body) {
        ...
        p = _koc.requestPage("POST", page, data, function(response, body) {
            return handleRecruit(_koc, body);
        });
    }
    return p;
...
koc.prototype.recruit = function(data) {
    return recruit("recruit.php", data);
};

koc.prototype.clicker = function(data) {
    return recruit("clicker.php", data);
};
